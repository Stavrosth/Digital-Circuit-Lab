...
HD_PWD='C:/Users/sstat/Documents/GitHub/Digital-Circuit-Lab/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AutoRotate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AutoRotate.tcl -notrace
